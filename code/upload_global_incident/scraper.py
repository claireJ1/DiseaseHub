...
def scraper():
    ...
    for i, event in enumerate(outbreaks):
        ...
        if i % 5 == 1:
            ...
            web_attr = soup.find_all("div", {"class":"mt-2 col-span-3 md:col-span-1"})
            for j, attributes in enumerate(web_attr):
                ...
                if j % 8 == 0:
                    ...
                    attribute["country"] = country[country.find("(")+1:country.find(")")]
                elif j % 8 == 3:
            ...
            link = soup.find("a", {"class":"text-black hover:text-orange-500"}).get("href")
